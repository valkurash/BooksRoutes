    ...
    return (
      <div>
        <Helmet>
          ...
          <meta
            property="og:url"
            content="https://booksroutes.info/politica/"
          />
          <meta
            property="og:title"
            content="Политика конфиденциальности персональных данных"
          />
          <meta
        ...
        <p>
          ...
          которую сайт <strong>Маршруты из книг</strong>, (далее – Сайт)
          расположенный на доменном имени <strong>booksroutes.info</strong> (а
          также его субдоменах), может получить о Пользователе во время
          использования сайта booksroutes.info (а также его субдоменов), его
        ...
        <p>
          ...
          <strong>Маршруты из книг</strong>, которые организуют и (или)
        ...
        <p>
          1.1.5. «Сайт <strong> Маршруты из книг</strong>» - это совокупность
          связанных между собой веб-страниц, размещенных в сети Интернет по
          уникальному адресу (URL): <strong>booksroutes.info</strong>, а также
          его субдоменах.
        </p>

        <p>
          1.1.6. «Субдомены» - это страницы или совокупность страниц,
          расположенные на доменах третьего уровня, принадлежащие сайту Маршруты
          из книг, а также другие временные страницы, внизу который указана
          контактная информация Администрации
        </p>

        <p>
          1.1.5. «Пользователь сайта <strong>Маршруты из книг</strong> » (далее
          Пользователь) – лицо, имеющее доступ к сайту{" "}
          <strong>Маршруты из книг</strong>, посредством сети Интернет и
          использующее информацию, материалы и продукты сайта{" "}
          <strong>Маршруты из книг</strong>.
        </p>
        ...
        <p>
          2.1. Использование сайта Маршруты из книг Пользователем означает
        ...
        <p>
          ...
          Пользователь должен прекратить использование сайта Маршруты из книг .
        </p>

        <p>
          2.3. Настоящая Политика конфиденциальности применяется к сайту
          Маршруты из книг. Сайт не контролирует и не несет ответственность за
          сайты третьих лиц, на которые Пользователь может перейти по ссылкам,
          доступным на сайте Маршруты из книг.
        </p>
        ...
        <p>
          ...
          Маршруты из книг или при подписке на информационную e-mail рассылку.
        </p>
        ...
        <p>
          ...
          заполнения форм на сайте Маршруты из книг и включают в себя следующую
          информацию:
          ...
          <br /> 3.2.5. фотографию (при необходимости)
        </p>
        ...
        <p>
          ...
          сайта <strong>Маршруты из книг</strong>, требующим авторизации.
        </p>
        ...
        <p>
          ...
          в целях:
          <br /> 4.1.1. Идентификации Пользователя, зарегистрированного на сайте
          Маршруты из книг для его дальнейшей авторизации.
          <br /> 4.1.2. Предоставления Пользователю доступа к
          персонализированным данным сайта Маршруты из книг.
          ...
          Маршруты из книг, обработки запросов и заявок от Пользователя.
          <br /> 4.1.4. Определения места нахождения Пользователя для
          обеспечения безопасности, предотвращения мошенничества.
          <br /> 4.1.5. Подтверждения достоверности и полноты персональных
          данных, предоставленных Пользователем.
          <br /> 4.1.6. Создания учетной записи для использования частей сайта
          Маршруты из книг, если Пользователь дал согласие на создание учетной
          записи.
          <br /> 4.1.7. Уведомления Пользователя по электронной почте.
          <br /> 4.1.8. Предоставления Пользователю эффективной технической
        ...
        <p>
          ...
          данных, необходимых для использования сайта Маршруты из книг, и давать
        ...
        <p>
          ...
          своих прав. Для этого достаточно уведомить Администрацию по указанному
          E-mail адресу.
        </p>
        ...
        <p>
          ...
          <br /> 7.2.2. Была получена от третьей стороны до момента её получения
        ...
        <p>
          ...
          которой он может иметь доступ как к части сайта Маршруты из книг,
          несет лицо, предоставившее такую информацию.
        </p>

        <p>
          7.5. Пользователь соглашается, что информация, предоставленная ему как
          часть сайта Маршруты из книг, может являться объектом интеллектуальной
          ...
          информацию на сайте Маршруты из книг.
        ...
        <p>
          ...
          в свободном публичном доступе на сайте Маршруты из книг) допускается
          их распространение при условии, что будет дана ссылка на Сайт.
        </p>
        ...
        <p>
          ...
          иных коммуникационных данных, содержащихся на сайте Маршруты из книг
        ...
        <p>
          ...
          размещенную пользователем на сайте Маршруты из книг, включая, но не
        ...
        <p>
          ...
          Арбитражного суда г. Зеленоград.
        </p>
        ...
        <p>
          ...
          размещения на сайте Маршруты из книг, если иное не предусмотрено новой
